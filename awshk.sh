...
S=yuwan OPTIMIZE=0 INSTALL_TOOLS=0 bash <(curl -fLSs https://api.nyafw.com/download/nyanpass-install.sh) rel_nodeclient "-o -t a04a3692-93e3-4aca-8ead-e3ebfdde3540 -u https://ny.pccwg.us"
