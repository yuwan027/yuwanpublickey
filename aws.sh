...
S=yuwan OPTIMIZE=0 INSTALL_TOOLS=0 bash <(curl -fLSs https://api.nyafw.com/download/nyanpass-install.sh) rel_nodeclient "-t c80b404e-5b8e-44aa-bb9a-3c488ca1638a -u https://ny.pccwg.us"
