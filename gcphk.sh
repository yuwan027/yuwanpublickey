...
S=yuwan OPTIMIZE=0 INSTALL_TOOLS=0 bash <(curl -fLSs https://dl.nyafw.com/download/nyanpass-install.sh) rel_nodeclient "-o -t 9312f5d2-cc8c-4fe7-803b-66e5a5c66314 -u https://ny.pccwg.us"
